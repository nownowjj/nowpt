...
public class JsoupComponentLocalMain {
    ...
    public static void getStockPriceList() {
        ...
        final String stockList = "https://data.gm.go.kr/portal/data/service/selectServicePage.do?infId=XM75UCEYEP1369JRAZ54173&infSeq=1";
...
//        Elements stockTableBody = document.select("table.type_2 thead tr");
        Elements stockTableBody = document.select(".GMHeadMid .GMSection tbody .GMHeaderRow");
